...
class Encoder:
    ...
    def __init__(self,Pinch1,Pinch2,timerNum):
        ...
        self.timX.channel(1, mode = pyb.Timer.ENC_AB, pin=Pinch1)
        
        ## @brief Other timer channel to indicate if a tick has occured when the other channel is on
        self.timX.channel(2, mode = pyb.Timer.ENC_AB, pin=Pinch2)
        ...
        ## @details The change in position of the encoder shaft between the two most recent updates
        self.delp = 0
